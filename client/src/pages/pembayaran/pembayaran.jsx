                                    ...
                                    <div className='grid-payment'>
                                        <div className='grid-payment-left'>
                                            ...
                                            >
                                                ...
                                                <img clasName="paymentImg"  src={briImg} alt='briva' />
                                            </div>
                                            <div
                                            ...
                                            >
                                                ...
                                                <img clasName="paymentImg" src={bniImg} alt='bni' />
                                            </div>
                                            <div
                                            ...
                                            >
                                                ...
                                                <img clasName="paymentImg" src={mandiriImg} alt='mandiri' />
                                            </div>
                                            <div
                                            ...
                                            >
                                                <h3>Bank Transfer</h3>
                                                <img clasName="paymentImg" src={permataImg} alt='permata' />
                                            </div>
                                            <div
                                            ...
                                            >
                                                <h3>GOPAY</h3>
                                                <img clasName="paymentImg" src={gopayImg} alt='gopay' />
                                            </div>
                                            <div
                                            ...
                                            >
                                                <h3>DANA</h3>
                                                <img clasName="paymentImg" src={danaImg} alt='dana' />
                                            </div>
                                            <div
                                            ...
                                            >
                                                <h3>Shoopeepay</h3>
                                                <img clasName="paymentImg" src={shopeeImg} alt='shopeepay' />
                                            </div>
                                        </div>
                                ...
                                <div className='payment-result'>
                                    <div className='payment-result-header'>
                                        {paymentResult === "Berhasil" ? (
                                            <img src={berhasilImg} alt='berhasil' />
                                        ) : (
                                            <img src={gagalImg} alt='gagal' />
                                        )}
                                        <h1
                                            style={{
                            ...
                            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                                <div className='modal-body'>
                                    <div className='head-body'>
                                        <FaCheckCircle size={84} color='#DF20A3' />
